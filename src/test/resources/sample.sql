...
INSERT INTO th_db.trim (id, name, description, model_id, engine_id, drivetrain_id, transmission_id, fuel_consumption, forced_induction) VALUES (1, 'sfgsdfg', 'iii', 2, 2, 3, 2, 345, 'sdfsdf');
